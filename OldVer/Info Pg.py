...
ImpedenceDisplay= Tkinter.Label(infowindow, text= AC.Impedence(Xc,Xl,AC.R))
...
PhaseAngleDisplay= Tkinter.Label(infowindow, text= AC.PhaseAng(Xc,Xl,AC.R))
PhaseAngleDisplay.grid(row=8, column=2,)

PhaseCoilDisplay= Tkinter.Label(infowindow, text= AC.PhaseNoC(Xl,AC.R))
PhaseCoilDisplay.grid(row=9, column=2,)

ApparentPDisplay= Tkinter.Label(infowindow, text= AC.ApparentPwr(AC.I,AC.Z))
ApparentPDisplay.grid(row=10, column=2,)

TruePDisplay= Tkinter.Label(infowindow, text= AC.TruePwr(AC.I,AC.R))
TruePDisplay.grid(row=11, column=2,)

ReactivePDisplay= Tkinter.Label(infowindow, text= AC.ReactivePwr(Xl
                                                                 ,Xc,AC.I))
